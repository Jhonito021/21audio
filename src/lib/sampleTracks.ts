import { AudioTrack, EqualizerPreset, RadioStation } from '../types';

export const SAMPLE_RADIO_STATIONS: RadioStation[] = [
  {
    id: 'radio-1',
    name: 'Chillhop Radio - Beats to Study/Relax',
    genre: 'Lo-Fi / Hip Hop',
    country: 'International',
    streamUrl: 'https://stream.zeno.fm/f3wvbbqmdg8uv',
    logoUrl: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=300&auto=format&fit=crop&q=80',
    bitrate: '320 kbps AAC',
    description: 'Direct live stream de beats lo-fi relaxants et chillhop pour le travail et la détente.'
  },
  {
    id: 'radio-2',
    name: 'FIP France - Jazz & Eclectic',
    genre: 'Eclectique / Jazz',
    country: 'France',
    streamUrl: 'https://icecast.radiofrance.fr/fip-midfi.mp3',
    logoUrl: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=300&auto=format&fit=crop&q=80',
    bitrate: '192 kbps MP3',
    description: 'La radio musicale la plus éclectique du monde sans aucune interruption commerciale.'
  },
  {
    id: 'radio-3',
    ...
    logoUrl: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=300&auto=format&fit=crop&q=80',
    bitrate: '256 kbps MP3',
    description: 'Musique d ambiance downtempo, ambient et chillout pour l inspiration.'
  },
  {
    id: 'radio-4',
    name: 'Electro Synthwave Live',
    genre: 'Synthwave / Cyberpunk',
    country: 'Allemagne',
    streamUrl: 'https://stream.synthwave.hu/live',
    logoUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=300&auto=format&fit=crop&q=80',
    bitrate: '320 kbps MP3',
    description: 'Retro synthwave, darkwave et sons futuristes années 80 en direct.'
  },
  {
    id: 'radio-5',
    name: 'Classical Masterpieces FM',
    genre: 'Classique',
    country: 'Autriche',
    streamUrl: 'https://stream.klassikradio.de/live/mp3-192/',
    logoUrl: 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=300&auto=format&fit=crop&q=80',
    bitrate: '192 kbps MP3',
    description: 'Les plus grands chefs-d œuvre de la musique classique en direct de Vienne.'
  }
];
