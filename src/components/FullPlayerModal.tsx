...
export const FullPlayerModal: React.FC<FullPlayerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#171717] text-white overflow-y-auto animate-in fade-in slide-in-from-bottom-8 duration-300">
      <div className="w-full max-w-md h-full flex flex-col justify-between p-5 relative overflow-hidden bg-gradient-to-b from-neutral-900 via-[#171717] to-black">
        {/* Background glow circle */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-[#c6ff34]/10 blur-3xl pointer-events-none" />
        ...
        <div className="flex items-center justify-between z-10 shrink-0 mb-2">
          ...
          <div className="text-center">
            <span className="text-[10px] uppercase font-bold tracking-widest text-[#c6ff34] bg-[#c6ff34]/10 px-2 py-0.5 rounded-full border border-[#c6ff34]/20">
              En cours de lecture
            </span>
          </div>
        ...
        <div className="my-auto py-2 z-10 flex flex-col items-center">
          {showLyrics ? (
            /* Lyrics View */
            <div className="w-full h-72 bg-neutral-900/90 border border-neutral-800 rounded-2xl p-4 overflow-y-auto backdrop-blur text-center space-y-3">
            ...
            <div className="relative group my-2">
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 rounded-3xl overflow-hidden bg-neutral-800 border-2 border-neutral-700/60 shadow-2xl shadow-[#c6ff34]/15">
                ...
                {isPlaying && (
                  <div className="absolute top-3 right-3 p-1.5 rounded-full bg-[#171717]/80 text-[#c6ff34] border border-[#c6ff34]/30 backdrop-blur">
        ...
        <div className="z-10 shrink-0 space-y-4 pt-2">
          ...
          <div className="flex items-center justify-between px-2">
            ...
            <button
              onClick={onPrev}
              className="p-3 text-white hover:text-[#c6ff34] active:scale-90 transition-transform cursor-pointer"
            >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={isLoading}
                className="w-16 h-16 rounded-2xl bg-[#c6ff34] text-[#171717] flex items-center justify-center shadow-xl shadow-[#c6ff34]/20 hover:bg-[#b5f020] transition-transform active:scale-95 cursor-pointer disabled:opacity-50"
              >
                {isLoading ? (
          ...
          <div className="pt-2 border-t border-neutral-800/80 flex items-center justify-between gap-3 text-xs">
            ...
            <div className="relative">
              ...
              {showSpeedMenu && (
                <div className="absolute bottom-8 right-0 bg-neutral-800 border border-neutral-700 rounded-lg p-1 space-y-1 shadow-xl z-30">
